...
const DataFlow = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 md:px-8 py-20 md:py-28">
      ...
      <div className="hidden md:flex items-center justify-center mt-8 gap-1">
        {[0, 1].map(i => (
          <div key={i} className="flex items-center gap-1">
            <div className="w-16 h-px bg-outline-variant/30" />
            <span className="material-symbols-outlined text-outline-variant/40" style={{ fontSize: 12 }}>arrow_forward</span>
          </div>
        ))}
      </div>
    </section>
