...
const SignalReadout = ({ scenario, t }) => (
  ...
  >
    <div className="flex items-start gap-3">
      <span className="mt-0.5 w-5 h-5 rounded bg-amber-100 flex items-center justify-center shrink-0">
        <span className="material-symbols-outlined text-amber-700" style={{ fontSize: 13 }}>warning</span>
      </span>
      <div>
    ...
    <div className="flex items-start gap-3">
      <span className="mt-0.5 w-5 h-5 rounded bg-primary/10 flex items-center justify-center shrink-0">
        <span className="material-symbols-outlined text-primary" style={{ fontSize: 13 }}>task_alt</span>
      </span>
      <div>
    ...
    <p className="text-[10px] text-on-surface-variant/40 italic">{t('hero.illustrative_label')}</p>
  </motion.div>
);
