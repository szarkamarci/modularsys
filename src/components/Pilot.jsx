  ...
  return (
    <section className="max-w-7xl mx-auto px-4 md:px-8 py-16 md:py-20">
      <div className="max-w-2xl">
        ...
        <dl>
          <ROW label={t('pilot.question_label')} value={t('pilot.question')} />
          <ROW label={t('pilot.data_label')} value={t('pilot.data')} />
          <ROW label={t('pilot.signal_label')} value={t('pilot.signal')} />
          <ROW label={t('pilot.use_label')} value={t('pilot.use')} />
        </dl>
      </div>
    </section>
  );
